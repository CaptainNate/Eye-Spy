                ...
                <Modal.Body className="modal-bg container">
                    <div className="row">
                        <div className="col-4 m-3 text-center align-items-center">
                            ...
                            <img src="../../images/placeholder-img.jpg" style={{height:"150px"}} alt="leandro" />
                            <p>Backend</p>
                        </div>
                        <div className="col-4 m-3 text-center align-items-center">
                            <h4 id="modal-body-title">Fernando</h4>
                            <img src="../../images/placeholder-img.jpg" style={{height:"150px"}} alt="Fernando" />
                            <p>Backend</p>
                        </div>
                        <div className="col-4 m-3 text-center align-items-center">
                            <h4 id="modal-body-title">Luiz</h4>
                            <img src="../../images/placeholder-img.jpg" style={{height:"150px"}} alt="Luiz" />
                            <p>Backend</p>
                        </div>
                        <div className="col-4 m-3 text-center align-items-center">
                            <h4 id="modal-body-title">Maggie</h4>
                            <img src="../../images/placeholder-img.jpg" style={{height:"150px"}} alt="Maggie" />
                            <p>Frontend</p>
                        </div>
                        <div className="col-4 m-3 text-center align-items-center">
                            <h4 id="modal-body-title">Nate</h4>
                            <img src="../../images/placeholder-img.jpg" style={{height:"150px"}} alt="Nate" />
                            <p>Frontend</p>
                        </div>
                        <div className="col-4 m-3 text-center align-items-center">
                            <h4 id="modal-body-title">Eric</h4>
                            <img src="../../images/placeholder-img.jpg" style={{height:"150px"}} alt="Eric" />
                            <p>PWA/Optimization</p>
                        </div>
                    </div>
                </Modal.Body>
