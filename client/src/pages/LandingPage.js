            ...
            <div className="d-flex pt-5 pb-5 align-items-center border-bottom border-dark">
                ...
                <div className="container">
                    ...
                    <div className="container-fluid p-2 card mb-3 scrolling-wrapper landingPage-secondaryBg shadow-lg">
                        ...
                        <div className="row d-flex flex-nowrap row g-0 landingPage-secondaryBg m-1">
                            {/* Static Reviews */}
                            <div className="col-sm-12 card card-body landingPage-tertiaryBg"><p>Wow! I never thought I would find a site like this. I was able to find so many cool and unique places that were so close to home!</p>
                                <p> - Scott H.</p></div>
                            <div className="col-sm-12 card card-body landingPage-tertiaryBg"><p>At first I thought it was such a weird webpage but it ended up being exactly what I was looking for! I can't even recommend it enough to anyone who likes being outdoors.</p>
                                <p>-Theodore M.</p></div>
                            <div className="col-sm-12 card card-body landingPage-tertiaryBg"><p>I never thought anyone would think of an idea to find these unique gems. I'm always searching for these and a lot of them are just not what I'm looking for. This hits the nail on the head.</p>
                                <p>-Cleo P.</p></div>
                            <div className="col-sm-12 card card-body landingPage-tertiaryBg"><p>What a refreshing site. It matches what I was looking for but just the webpage was so pleasant and nice to look at. I wish I could keep looking. I love the feature being able to add our own suggestions onto the website too! I feel so engaged.</p>
                                <p>-Lilliana L.</p></div>
                        </div>
                    </div>
