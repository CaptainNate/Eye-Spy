        ...
        <div className="col-10 p-4 m-2 shadow-lg floating-box-bg">
          ...
          <div className="card col-4 p-3 dashboard-card-bg">
            ...
            <ul className="list-group list-group-flush text-center">
              ...
              <li className="list-group-item dashboard-card-bg">Address/Location Name</li>
            </ul>
            {/* Add Comment */}
            <div className="mt-2">
            ...
            <div className="card-body text-center">
              {/* Open Modal */}
              <Button variant="primary" className="dashboard-btn p-2 rounded" onClick={() => setModalShow(true)}>
                Show all comments
              </Button>
