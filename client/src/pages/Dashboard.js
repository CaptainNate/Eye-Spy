  ...
  return (
    ...
    <div className="container">
      <div className="d-flex row justify-content-between text-center m-5">
        <div className="col-6">
          <div className="text-center m-5">
            <h2 className='mb-4 pb-4 border-bottom border-dark'>Welcome, User's Name</h2>
        ...
        <div className="col-6">
          <div className='text-center m-5'>
            <h2 className='mb-4 pb-4 border-bottom border-dark'>Your next adventure is waiting!</h2>
      ...
      <div className="row d-flex justify-content-between mt-3">
        <div>
          <h2 className="text-center m-3 border-bottom border-dark p-3">User Name's Favorite Places</h2>
        </div>
        {/* Card Layout */}
